...
**IMPORTANT:** When someone sends you a connection request, you will receive a notification
in your Contacts Hub room. You are responsible for reviewing each request and deciding
whether to approve or reject it using the \`thenvoi_respond_contact_request\` tool.
